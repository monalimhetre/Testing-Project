...
<body>
      <div class="logo"><h1><a href="/maintenance_system/listAdmin.jsp">UTA MAC Maintenance System</a></h1></div>
      <div class="menu_nav">
  </div>
...
<tr>
	<td>
	<form action="/maintenance_system/UserController?action=searchUserToEditForAdmin" method="post">
