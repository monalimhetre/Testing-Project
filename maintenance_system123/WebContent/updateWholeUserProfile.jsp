...
<div class="header_resize">
      <div class="logo"><h1><a href="/maintenance_system/listAdmin.jsp">MAC Maintenance System Home</a></a></h1></div>
      <div class="menu_nav">
      </div>
    ...
    <input name="action" value="updateUserInDBToEditUserProfileForAdmin" type="hidden">
